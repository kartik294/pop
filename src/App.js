...
export default function App() {
  ...
  const [watched, setWatched] = useState([]); // Replace with your data
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched }) {
  ...
  function handleAdd() {
    const newWatchedMovie = {
      ...
      runtime: movie.Runtime ? Number(movie.Runtime.split(" ")[0]) : 0,
    };
  ...
  useEffect(() => {
    ...
    getMovieDetails(); // Call the function when the component mounts
  }, [selectedId]);
...
function WatchedMovie({ movie }) {
  ...
  if (
    ...
    typeof userRating === "undefined" ||
    typeof runtime === "undefined"
  ) {
    return <div>Movie data is incomplete</div>;
  }
